...
public:
    ...
    void addMultiButton(Button* pb, std::vector<Command*> commands) {
        mButtons.push_back(pb);
        mCommands.push_back(new MultiCommand(commands));
    }
};
...
int main()
{
    ...
    Command* randomColorsCmd = new RandomAllColorsCommand(pool);
    Command* randomPositionsCmd = new RandomAllPositionsCommand(pool);
    ...
    control.addMultiButton(new Button(window, {40, 380, 240, 40}, font, "Random Colors+Pos"), {randomColorsCmd, randomPositionsCmd});
    control.addButton(new Button(window, {40, 440, 240, 40}, font, "Random All Colors"), new RandomAllColorsCommand(pool));
    control.addButton(new Button(window, {40, 500, 240, 40}, font, "Clear All"), new ClearAllShapesCommand(pool));
